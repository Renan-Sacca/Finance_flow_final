                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'dt7xz94y' /* Choose what notifcations you w... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: SwitchListTile.adaptive(
                      ...
                      title: Text(
                        FFLocalizations.of(context).getText(
                          '0tp263qz' /* Push Notifications */,
                        ),
                        style: FlutterFlowTheme.of(context).title3,
                      ),
                      subtitle: Text(
                        FFLocalizations.of(context).getText(
                          '70greml2' /* Receive Push notifications fro... */,
                        ),
                        style: FlutterFlowTheme.of(context).bodyText1,
                      ),
                  ...
                  SwitchListTile.adaptive(
                    ...
                    title: Text(
                      FFLocalizations.of(context).getText(
                        'bvqbjigw' /* Email Notifications */,
                      ),
                      style: FlutterFlowTheme.of(context).title3,
                    ),
                    subtitle: Text(
                      FFLocalizations.of(context).getText(
                        'qwz5c4hk' /* Receive email notifications fr... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText1,
                    ),
                    tileColor: Color(0xFFF5F5F5),
                  ...
                  SwitchListTile.adaptive(
                    ...
                    title: Text(
                      FFLocalizations.of(context).getText(
                        '637klodz' /* Location Services */,
                      ),
                      style: FlutterFlowTheme.of(context).title3,
                    ),
                    subtitle: Text(
                      FFLocalizations.of(context).getText(
                        '80r3vg9s' /* Allow us to track your locatio... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText1,
                    ),
                    tileColor: Color(0xFFF5F5F5),
