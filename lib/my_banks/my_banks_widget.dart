...
import '../banco_detalhes/banco_detalhes_widget.dart';
              ...
              StreamBuilder<List<BancoRecord>>(
                stream: queryBancoRecord(
                  queryBuilder: (bancoRecord) => bancoRecord
                      .where('banco_users', isEqualTo: currentUserUid),
                ),
                        ...
                        child: InkWell(
                          onTap: () async {
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => BancoDetalhesWidget(
                                  bancoDetails: listViewBancoRecord.reference,
                                ),
                              ),
                            );
                          },
