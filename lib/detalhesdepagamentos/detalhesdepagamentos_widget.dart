                    ...
                    await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => TransactionEDITWidget(
                          transactionDetails:
                              detalhesdepagamentosTransactionsRecord.reference,
                        ),
                      ),
                    );
                  },
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            detalhesdepagamentosTransactionsRecord.categoryName,
                        ...
                        StreamBuilder<List<ParcelasRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children:
                                  List.generate(columnParcelasRecordList.length,
                                      (columnIndex) {
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'agugs5ut' /* Has already been paid */,
                                                ),
                                                style:
