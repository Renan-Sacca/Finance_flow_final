                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'swpfw89m' /* Edit transaction amount */,
                                ),
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller: textController2 ??=
                                      TextEditingController(
                                    text: editarfaturafixaFaturaFixaRecord.valor
                                        .toString(),
                                  ),
                                  onChanged: (_) => EasyDebounce.debounce(
                                    'textController2',
 ...
 */
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'es4vvou1' /* Tap above to save your changes... */,
                      ),
