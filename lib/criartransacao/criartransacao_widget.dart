 ...
 */
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '74n4zuju' /* Deduct value from bank balance... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                                      .override(
            ...
            Text(
              FFLocalizations.of(context).getText(
                'xhxc63gy' /* Tap above to complete transfer */,
              ),
