          ...
          children: [
            Column(
              ...
              children: [
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: AutoSizeText(
                                  FFLocalizations.of(context).getText(
                                    'lws0486o' /* Choose the bank to cash: */,
                                  ),
                            ...
                            Padding(
                              ...
                              child: StreamBuilder<List<BancoRecord>>(
                                stream: queryBancoRecord(
                                  queryBuilder: (bancoRecord) =>
                                      bancoRecord.where('banco_user',
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'glwhjbxn' /* Tap above to complete transfer */,
                  ),
